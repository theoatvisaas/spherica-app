                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 4.0),
                                child: Text(
                                  'Digite o nome da pessoa que você quer criar o perfil',
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.profileCreated =
                              await ProfilesGroup.createProfileCall.call(
                          ...
                          if (_model.titleTextController.text != null &&
                            ...
                            _model.createdRevenue =
                                await RevenueGroup.createRevenueCall.call(
                              title: _model.titleTextController.text,
                              description: _model.messageTextController.text,
                              profilesId: ProfileStruct.maybeFromMap(
                                      (_model.profileCreated?.jsonBody ?? ''))
                                  ?.id,
                              image: _model.uploadedLocalFile,
                              token: currentAuthenticationToken,
                            );

                            if ((_model.createdRevenue?.succeeded ?? true)) {
                              ...
                              _model.apiResultnxh =
                                  await ProfilesGroup.getProfilesCall.call(
                                clientsId: currentUserData?.client?.id,
                                token: currentAuthenticationToken,
                              );
                            ...
                            if ((_model.profileCreated?.succeeded ?? true)) {
                              await ProfilesGroup.getProfilesCall.call(
                                clientsId: currentUserData?.client?.id,
                                token: currentAuthenticationToken,
                              );
